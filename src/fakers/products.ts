    ...
    const products: Array<Product> = [
      {
        ...
        name: "County Championship day three...",
        price: 149.99,
        isActive: true,
        stock: 50,
      ...
      },
      {
        ...
        name: "FORMULA 1 PRE-SEASON TRACK S...",
        price: 19.99,
        isActive: false,
        stock: 25,
        category: categories.fakeCategories()[0],
      ...
      },
      {
        ...
        name: "BahrainFORMULA 1 GULF AIR BAHRAIN GR...",
        price: 799.99,
        isActive: true,
        stock: 60,
        category: categories.fakeCategories()[0],
